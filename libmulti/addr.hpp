...
{
	explicit protocol(int _code, int _size, std::string _name, bool _path, transcoder _transcoder = transcoder())
		: m_code(_code), m_size(_size), m_name(_name), m_path(_path), m_transcoder(_transcoder)
	{
