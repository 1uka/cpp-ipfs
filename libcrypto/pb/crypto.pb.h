...
#ifndef PROTOBUF_INCLUDED_crypto_2eproto
#define PROTOBUF_INCLUDED_crypto_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_crypto_2eproto 
...
namespace google {
namespace protobuf {
template<> ::crypto::pb::PrivateKey* Arena::CreateMaybeMessage<::crypto::pb::PrivateKey>(Arena*);
template<> ::crypto::pb::PublicKey* Arena::CreateMaybeMessage<::crypto::pb::PublicKey>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace crypto {
namespace pb {
...
class PrivateKey : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:crypto.pb.PrivateKey) */ {
 public:
  ...
  inline PrivateKey* New() const final {
    return CreateMaybeMessage<PrivateKey>(NULL);
  }

  PrivateKey* New(::google::protobuf::Arena* arena) const final {
...
template <> struct is_proto_enum< ::crypto::pb::KeyType> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_crypto_2eproto
